...
import ma.emsi.dhissiayman.tp2.Assistants.Assistant;
...
public class Test5 {
    ...
    public static void main(String[] args) {
        ...
        ChatModel model = GoogleAiGeminiChatModel.builder()
                .apiKey(llmKey)
                // Nom de modèle compatible avec langchain4j 1.7.x
        ...
        // Le LLM va utiliser l'information du fichier langchain4j.pdf pour répondre à la question.
